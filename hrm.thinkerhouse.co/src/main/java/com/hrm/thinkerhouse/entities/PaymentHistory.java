...
public class PaymentHistory {
	...
	public PaymentHistory(int idPaymentHistory, Date paymentDate, String paymentBy, String reference, Date createDate,
			Date updateDate, Employee employee, Payroll payroll) {
		super();
		this.idPaymentHistory = idPaymentHistory;
		this.paymentDate = paymentDate;
		this.paymentBy = paymentBy;
